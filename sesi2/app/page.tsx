...
export default function Home() {
  return (
    <div className="bg-gradient-to-r from-blue-400 to-indigo-500 text-white font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center h-screen relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center text-white z-10 mt-6 md:mt-0 md:ml-8">
          ...
          <Button className="bg-indigo-600 hover:bg-indigo-700 py-2 px-6 rounded-full text-lg font-semibold hover:scale-105">
